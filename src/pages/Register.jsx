...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const credential = await registerUser(name, email, password);
      // Fallback update contexts
    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex flex-1 items-center justify-center px-8 py-12"
        ...
        <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}
          ...
          <p className="text-white/40 text-sm mb-8">Sign up to kickstart your portfolio</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-center text-xs text-white/40 mt-6">
              ...
              <Link to="/" className="text-brand-400 hover:text-brand-300 font-semibold transition-colors">
                Sign in
              </Link>
            </p>
